...
export default function Alert({ message, setCopied }) {
    return (
        <div className='absolute left-4 top-1 w-full'>
            <div id="toast-success" className="animate__animated animate__bounceInRight flex items-center absolute overflow-x-hidden top-5 right-10 p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
